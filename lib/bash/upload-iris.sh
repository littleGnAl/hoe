...
JENKINS_UPLOAD_MAVEN_URL="http://10.80.1.18:8080/job/GA/job/Agora-Publish-Jcenter"
JENKINS_UPLOAD_POD_URL="http://10.80.1.18:8080/job/GA/job/Pod_Package"

bash $MY_PATH/upload-manual-cdn-url.sh ${IRIS_ANDROID_UPLOAD_CDN_URL}
bash $MY_PATH/upload-maven.sh ${JENKINS_UPLOAD_MAVEN_URL} $RELEASE_VERSION "${SDK_CDN_BASE_URL}/${IRIS_ANDROID_NAME}" "libAgoraRtcWrapper.so" "iris-rtc"
